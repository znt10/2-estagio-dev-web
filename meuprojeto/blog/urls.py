...
from .views import Post_ver, Post_DetailView, Post_CreateView, Post_UpdateView, Post_DeleteView
...
urlpatterns = [
    ...
    path('<int:pk>/deletar/', Post_DeleteView.as_view(), name='deletar_post'),
]
